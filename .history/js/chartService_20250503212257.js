...
const chartService = {
    ...
    createTechnologyChart: function(techByAccountData, viewMode) {
        ...
        // Log for debugging
        console.log(`Rendering technology chart with ${plotlyData.length} technology areas and ${topAccounts.length} accounts`);
    ...
    createAccountTechChart: function(techBreakdown, viewMode) {
        ...
        // Log for debugging
        console.log(`Rendering account tech chart with ${techData.length} technology areas`);
